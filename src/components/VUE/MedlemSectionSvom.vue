...
import EnkeltbilletComp from "./EnkeltbilletComp.vue";
import FlerturskortComp from "./FlerturskortComp.vue";
import SvommeTillaeg from "./SvommeTillaeg.vue";
...
const toggleAccordion = computed(() => {
  medlemHeight.value =
    medlemHeight.value === "-webkit-fit-content"
      ? "350px"
      : "-webkit-fit-content";
});
...
<template>
  <div class="full-width flex column align medlem-cont">
    <div class="full-width flex row align top blue-sunrise">
      <div class="content-cont flex align">
        <h2>Svømmehal & Wellness priser</h2>
      </div>
    </div>
    <div
      class="medlem full-width flex column"
      :style="{ height: medlemHeight }"
    >
      <EnkeltbilletComp />
      <FlerturskortComp />
      <SvommeTillaeg />
      ...
      <div
        class="full-width flex align accordion blue-sunrise"
